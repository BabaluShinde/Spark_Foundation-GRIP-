...
<html lang="en">
  <head>
    ...
    <title>Spark Foundation Bank | History</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="navigation">
          <div class="logo">
              <img src="icon_bank.png" alt="logo" style="height: 30px;">
      ...
      <h1 class="text-center font-weight-bold mb-5"><img src="coin.png"> Transfer Money <img src="coin.png"></h1>
    ...
    <!----------Footer---------->
    <footer id="footer">
      <p>&copy; Copyright 2023  <span class="footer_logo">Spark Foundation Bank</span></p>
      <div class="social-icon">
              <a href="https://www.linkedin.com/in/babalu-shinde-31268620a/"><i class="fab fa-linkedin-in"></i></a>
              <a href="mailto: babalushinde1312@gmail.com"><i class="fas fa-envelope"></i></i></a>
